        ...
        {!revealed && (
          <div className="tear-paper-root" ref={paperRef}>
            <div className="tear-paper-inner" ref={contentRef}>
              ...
              <p>קוראים לי עמית ברין, וכבר 23 שנים שאני עושה כל מה שקשור בעיצוב גרפי בצורה מסחרית; במהלך השנים האלה צברתי פרסים – מקומיים וגם בינלאומיים – על הישגים תקדימיים באמת שהגעתי אליהם בעולמות השיווק, הפרסום והמיתוג, בעבודות על המותגים המובילים בעולם (<strong>וגם בארץ</strong> 🇮🇱!). אבל אפילו מעבר לפרסים ולתארים האלה: זכיתי לעבוד עם עשרות עסקים קטנים, לעזור להם להגשים חלומות – משלב היזמות ועד לשלב שבו המותג שיצרתי עבורם מבוסס, פעיל ומצליח, ומייצר עבורם ערך משמעותי.</p>

              <p><strong>לא החליפו אותי – התווספו אלי:</strong></p>

              <p>בשנתיים האחרונות אני מוסיף לארגז הכלים שלי לא מעט כלי בינה מלאכותית יוצרת (Generative Ai) כמעט מדי יום. אני בוחן אותם – בהתחלה במשחק והתנסות משועשעת עד למצב שאני מנסה לראות אם הם נשברים בקצה גבול היכולת שלהם – ואז אני מפנים תובנות מההתנסות ומטמיע יישומים של התוספות החדשות בעולם המקצועי שלי.</p>

              <p>כל אחד שנחשף לכלים האלו יכול להעיד שזה הולך ונהיה יותר ויותר קשה להפסיק להוסיף לארגז הכלים הזה עוד ועוד יכולות מדי יום. תבינו, אם היה באמת ארגז כלים כזה, בטח כבר הייתי צריך להחליף אותו באיזו ארונית יותר גדולה שתלך ותתמלא גם היא, אבל עם כאלה כוחות חדשים, ועם כזה שטף פנטסטי של יצירה – מי רוצה לעצור בכלל? אני הרי יותר מדי סקרן והרפתקן בשביל לעצור את השינוי הבלתי פוסק הזה, אני נהנה מתחושת אקספרימנטליות ביצירה (אבל ממש!) שומר על מחויבות לחדשנות, להתייעלות ולאפקטיביות, ותמיד מקפיד לעשות משהו <em>אחר</em> כדי להיות בטוח שהתוצר שאני מביא יהיה שונה מכל מה שהיה כבר, מכל מה שהכירו, וביחד עם השאיפה הטרחנית ממש למצוא פתרון פשוט וקל כדי לעזור לאנשים – אלה הדברים שמנחים אותי בקבלת החלטות, בלי תלות בכלים או בדרכי הביצוע.</p>

              <p>למעשה, אפשר לומר שהניסיון, הידע והתכונות האלה – אלה הם כלי העבודה האמיתיים שלי.</p>

              <p className="tp-gap"><strong>אה! ואני גם מרצה ומלמד את כל זה:</strong></p>

              <p>כבר עשר שנים שאני גם מנטור ומורה לעיצוב, עם מאות רבות של בוגרות מוכשרות (<em>ובוגרים מוכשרים!</em>) שיעידו על השינוי הגדול שעזרתי להם לבצע בחייהם, בעזרת ההוראה והמנטורינג, עד להגשמה עצמית שלהן; על סמך כל הידע הזה והניסיון בהנגשה שלו לקהלים צעירים ולא מקצועיים, אני מעביר גם הרצאות, הדרכות והסמכות בנושאי חשיבה עיצובית, כלי עיצוב ובינה מלאכותית גם במגזר העסקי – לחברות ולסטודיואים לעיצוב שמבקשים להתקדם אל העולם החדש.</p>
