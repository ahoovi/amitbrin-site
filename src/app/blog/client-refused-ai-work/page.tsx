 ...
 *  Route: /blog/client-refused-ai-work · Assets: /public/media/blog/client-refused-ai-work/
 * ===================================================================== */
    ...
    <div className="bp-root" dir="rtl" lang="he">
      ...
      <header className="hero">
        ...
        <div className="hero-card" data-reveal>
          ...
          <p className="hero-meta">
           ...
           · <PostDate slug="client-refused-ai-work" /></p>
        </div>
      ...
      <article className="body">
        ...
        <figure className="video-full" data-reveal>
          <video
            src="/media/blog/client-refused-ai-work/snake-brush.mp4"
            aria-label="סרטון: יצירת מברשת הנחש באילוסטרייטור. התיאור המלא נמצא בכיתוב מתחת לסרטון."
            controls
            playsInline
            preload="metadata"
            poster="/media/blog/client-refused-ai-work/snakes-cover.jpg"
          />
          <figcaption>
        ...
        <PostFooter slug="client-refused-ai-work" title={POST_TITLE} />
