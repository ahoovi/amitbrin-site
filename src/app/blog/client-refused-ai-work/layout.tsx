...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "פרי עץ הדעת",
    description: "מה קורה לאמון בין מעצב ללקוח כשההנחה שמשהו נוצר במכונה מספיקה כדי לפסול אותו, בלי לבדוק.",
    images: [{ url: "/media/og/og-client-refused-ai-work.jpg", width: 1200, height: 630, alt: "איור נחשים בעבודה על מסך, מתוך הפוסט" }],
  },
  twitter: {
    ...
    title: "פרי עץ הדעת",
    description: "מה קורה לאמון בין מעצב ללקוח כשההנחה שמשהו נוצר במכונה מספיקה כדי לפסול אותו, בלי לבדוק.",
    images: ["/media/og/og-client-refused-ai-work.jpg"],
  },
};
