...
export function GET() {
  const lines = [
    ...
    "## מי זה",
    "",
    "עמית ברין (Amit Brin). למד תקשורת חזותית באסכולה — בית ספר לעיצוב בתל אביב,",
    "ולימודי עיצוב לדיגיטל ב-6b studio. לימד במסלול לעיצוב גרפי ובקורס המתקדם",
    "לעיצוב UX/UI של 6b studio. כיום מלמד עיצוב UX במסלול לתקשורת באוניברסיטת רייכמן.",
    "",
    "## עיקרי האתר",
    "",
